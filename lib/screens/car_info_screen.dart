                          ...
                          children: [
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                filled: true,
                                fillColor: darkTheme ? Colors.grey : Colors.black12,
                                ...
                                prefixIcon: Icon(Icons.person, color: darkTheme ? Colors.black54 : Colors.grey,),
                              ),
                            ...
                            DropdownButtonFormField(
                              decoration: InputDecoration(
                                ...
                                prefixIcon: Icon(Icons.car_crash, color: darkTheme ? Colors.black54 : Colors.grey,),
                                filled: true,
                                fillColor: darkTheme ? Colors.grey : Colors.black12,
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(40),
                              ...
                              items: carTypes.map((car){
                                return DropdownMenuItem(
                                  child: Text(
                                    car,
                                    style: TextStyle( color: darkTheme ? Colors.white : Colors.grey),
                                  ),
                                  value: car,
                                );
                              }).toList(),
